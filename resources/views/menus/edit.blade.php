...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit {{ $menu->code }}</li>
@endsection
    ...
    <div class="col-lg-8">
        <div class="card premium-card">
            <div class="premium-header">
                <h5 class="m-0 fw-semibold text-dark"><i class="fa-solid fa-edit text-success me-2"></i> Form Edit Menu</h5>
            </div>
                ...
                <form action="{{ route('menus.update', $menu->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="code" id="code" class="form-control" placeholder="Contoh: TEA-001" value="{{ old('code', $menu->code) }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="name" class="form-label fw-medium text-dark">Nama Menu <span class="text-danger">*</span></label>
                            <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Green Tea Original" value="{{ old('name', $menu->name) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="price" id="price" min="0" step="100" class="form-control" placeholder="Contoh: 11000" value="{{ old('price', (int) $menu->price) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="card p-3 bg-light border mb-4">
                        ...
                        <div class="form-check mb-3">
                            <input type="checkbox" name="use_global_profit" id="use_global_profit" class="form-check-input" value="1" {{ old('use_global_profit', $menu->use_global_profit ? '1' : '0') == '1' ? 'checked' : '' }}>
                        ...
                        <div class="mb-2" id="customProfitContainer">
                            ...
                            <div class="input-group" style="max-width: 200px;">
                                <input type="number" name="profit_percentage" id="profit_percentage" min="0" max="100" step="0.1" class="form-control" placeholder="Contoh: 35" value="{{ old('profit_percentage', $menu->profit_percentage) }}" {{ old('use_global_profit', $menu->use_global_profit ? '1' : '0') == '1' ? 'disabled' : '' }}>
                    ...
                    <div class="form-check mb-4">
                        <input type="checkbox" name="status" id="status" class="form-check-input" value="1" {{ old('status', $menu->status ? '1' : '0') == '1' ? 'checked' : '' }}>
