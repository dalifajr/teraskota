...
@section('page_title', 'Kasir / Input Transaksi')
    ...
    <div class="col-lg-5 col-xl-4">
        <div class="card premium-card h-100">
            <div class="premium-header">
                <h5 class="m-0 fw-semibold text-dark"><i class="fa-solid fa-shopping-cart text-success me-2"></i> Keranjang Belanja</h5>
            </div>
            <div class="card-body p-4 d-flex flex-column" style="min-height: 500px;">
                
                <form action="{{ route('transactions.store') }}" method="POST" id="checkoutForm" class="d-flex flex-column h-100 flex-grow-1">
                    @csrf
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-6">
                            ...
                            <input type="date" name="transaction_date" id="transaction_date" class="form-control form-control-sm" value="{{ $todayDate }}" required>
                        </div>
                        <div class="col-6">
                            <label for="transaction_time" class="form-label small fw-semibold text-muted">Waktu Transaksi</label>
                            <input type="time" name="transaction_time" id="transaction_time" class="form-control form-control-sm" value="{{ $nowTime }}" required>
                        </div>
                    </div>
                    ...
                    <!-- Hidden Inputs Container for POST Array -->
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="notes" id="notes" rows="2" class="form-control form-control-sm" placeholder="Catatan tambahan..."></textarea>
                    </div>

                    <!-- Form Buttons -->
                    <div class="row g-2">
                        <div class="col-6">
                            <button type="button" class="btn btn-outline-secondary w-100 py-2 btn-sm fw-semibold" onclick="clearCart()"><i class="fa-solid fa-rotate-left me-1"></i> Reset</button>
                        </div>
                        <div class="col-6">
                            <button type="submit" class="btn btn-primary-green w-100 py-2 btn-sm fw-semibold"><i class="fa-solid fa-save me-1"></i> Simpan</button>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    function renderCart() {
        ...
        cart.forEach((item, index) => {
            ...
            // Create hidden inputs for request payload
